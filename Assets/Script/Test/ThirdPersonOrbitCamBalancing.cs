...
public class ThirdPersonOrbitCamBalancing : MonoBehaviour 
{
	public GameObject Mist;
	Xbox_Controls_Balancing BalancingControl;
	Xbox_Controls NormalControl;
	...
	void Start(){
		BalancingControl = Mist.GetComponent<Xbox_Controls_Balancing> ();
		NormalControl = Mist.GetComponent<Xbox_Controls> ();
